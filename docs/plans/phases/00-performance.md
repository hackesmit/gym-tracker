...
- New consolidated endpoint `GET /api/dashboard` (`routers/dashboard.py`) returning: `today_quest`, `week_stats`, `recent_prs`, `medal_summary`, `muscle_ranks`, `feed` in a single payload.
