...
import {
  getRanks, getMyMedals, getCompare, getCalendarOverview,
} from '../api/client';
...
export default function Profile() {
    ...
    const load = async () => {
      try {
        ...
        if (targetId) {
          ...
          // Friend calendar endpoint is not yet scoped; skip calendar for now.
          setCalendar([]);
        } else {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Training calendar (self only; friend calendar not yet exposed) */}
      {!targetId && (
