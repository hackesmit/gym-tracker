...
#
# Registered BEFORE "/{program_id}": FastAPI matches routes in declaration
# order, so a static path declared after the int parameter is captured by it
# and answers 422 ("calendar-overview" is not a valid integer).
#
